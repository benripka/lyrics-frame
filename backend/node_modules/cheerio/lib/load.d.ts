...
import { CheerioOptions, InternalOptions } from 'cheerio/lib/options';
...
import type * as Load from 'cheerio/lib/load';
import { SelectorType, BasicAcceptedElems } from 'cheerio/lib/types';
