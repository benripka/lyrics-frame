 ...
 * @category Cheerio
 */
export type { Cheerio } from 'cheerio/lib/cheerio';
/**
 * Types used in signatures of Cheerio methods.
 *
 * @category Cheerio
 */
export * from 'cheerio/lib/types';
export type { CheerioOptions, HTMLParser2Options, Parse5Options, } from 'cheerio/lib/options';
/**
...
export * from 'cheerio/lib/load';
declare const _default: import("cheerio/lib/load").CheerioAPI;
/**
...
import * as staticMethods from 'cheerio/lib/static';
/**
